...
def parse_analysis(text):
    ...
    exclude_words = ['MA', 'US', 'ETF', 'IPO', 'CEO', 'CFO', 'AI', 'GPU', 'ARK', 'SPY', 'QQQ', 'THE', 'FOR', 'AND', 'USD', 'CNY']
...
def main():
    ...
    if analysis_text:
        ...
        if result.get('success'):
            print(f"✅ 每日投资晨报推送成功")
            print(f"   报告长度: {len(parsed['full_report'])} 字符")
        else:
